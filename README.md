...
- Racks reserve clear sorting lanes between tiles, with the clue lozenge itself showing the sorted position. Deck counts are rendered on the 3D pile, and selecting a public tile is indicated by its lift rather than a DOM outline.
