...
declare module '$env/static/private' {
	...
	export const CONDUCTOR_LAST_COMMENT_URL: string;
	export const PAGER: string;
	export const npm_config_userconfig: string;
	export const npm_config_local_prefix: string;
	export const npm_config_yes: string;
	export const COLOR: string;
	export const CONDUCTOR_PERSONA: string;
	export const LOGNAME: string;
	export const RUNNER_OS: string;
	export const npm_config_npm_version: string;
	export const npm_config_prefix: string;
	export const GEMINI_CLI: string;
	export const CONDUCTOR_TARGET_DIR: string;
	export const _: string;
	export const npm_config_cache: string;
	export const CONDUCTOR_TOKEN: string;
	...
	export const GEMINI_CLI_TRUST_WORKSPACE: string;
	...
	export const CONDUCTOR_ROOT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		CONDUCTOR_LAST_COMMENT_URL: string;
		PAGER: string;
		...
		RUNNER_ARCH: string;
		LANG: string;
		GEMINI_CLI_TRUST_WORKSPACE: string;
